...
public class FightControlForPvp : MonoBehaviour
{
    public static FightControlForPvp instance;
    ...
    IEnumerator GunMuTrapAttack(FightCardData attackUnit, float damageRate, int dizzedRate)
    {
        ...
        FightCardData[] fightCardDatas = attackUnit.isPlayerCard ? FightManagerForPvp.instance.enemyFightCardsDatas : FightManagerForPvp.instance.playerFightCardsDatas;
    ...
    public void JianLouYuanSheSkill(FightCardData attackUnit, int finalDamage)
    {
        ...
        FightCardData[] fightCardDatas = isPlayerRound ? FightManagerForPvp.instance.enemyFightCardsDatas : FightManagerForPvp.instance.playerFightCardsDatas;
            ...
            if (attackUnit.fightState.imprisonedNums <= 0) //攻击者没有禁锢状态
            {
                switch (LoadJsonFile.heroTableDatas[attackUnit.cardId][5])
                {
                    ...
                    case "4":
                        ...
                        {
                            FightManagerForPvp.instance.CreateSateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_withStand, true);
                        }
    ...
    IEnumerator SpecialHeroSkill1(float damageBonus, FightCardData attackUnit, FightCardData attackedUnit)
    {
        ...
        if (attackUnit.fightState.imprisonedNums > 0) //禁锢，不进行技能攻击
        {
            ...
            if (attackUnit.fightState.imprisonedNums <= 0)
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_imprisoned, true);
            }
        }
        else
        {
    ...
    IEnumerator TongShuaiSkill(FightCardData attackUnit, int classType)
    {
        ...
        if (attackUnit.isPlayerCard)
        {
            ...
            fightCardDatas = FightManagerForPvp.instance.enemyFightCardsDatas;
            posListToSetBurn = FightManagerForPvp.instance.enemyCardsPos;
        }
        else
        {
            burnRoundIndex = tongShuaiBurnRoundEm;
            fightCardDatas = FightManagerForPvp.instance.playerFightCardsDatas;
            posListToSetBurn = FightManagerForPvp.instance.playerCardsPos;
        }
    ...
    private bool ShuShiTakeThunder(FightCardData attackUnit, int classType)
    {
        string effectStr = classType + "A";
        FightCardData[] fightCardDatas = attackUnit.isPlayerCard ? FightManagerForPvp.instance.enemyFightCardsDatas : FightManagerForPvp.instance.playerFightCardsDatas;
        List<GameObject> posListToThunder = attackUnit.isPlayerCard ? FightManagerForPvp.instance.enemyCardsPos : FightManagerForPvp.instance.playerCardsPos;
        List<int> canFightUnits = new List<int>();
        for (int i = 0; i < fightCardDatas.Length; i++)
        {
            canFightUnits.Add(i);
    ...
    IEnumerator DaoBingLianZhan(float damageBonus, FightCardData attackUnit, FightCardData attackedUnit)
    {
        ...
        else
        {
            if (attackedUnit.nowHp <= 0 && attackedUnit.cardType != 522)
            {
                ...
                FightCardData nextAttackedUnit = attackUnit.isPlayerCard ? FightManagerForPvp.instance.enemyFightCardsDatas[targetIndex] : FightManagerForPvp.instance.playerFightCardsDatas[targetIndex];
    ...
    {
        FightCardData[] fightCardDatas = attackUnit.isPlayerCard ? FightManagerForPvp.instance.playerFightCardsDatas : FightManagerForPvp.instance.enemyFightCardsDatas;
    ...
    public void UpdateTieQiStateIconShow(FightCardData tieQiCard, bool isAdd)
    {
        ...
        {
            FightManagerForPvp.instance.DestroySateIcon(tieQiCard.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_lianHuan, true);
        ...
        if (tieQiCards.Count > 1)
        {
            ...
            {
                FightManagerForPvp.instance.CreateSateIcon(tieQiCards[0].cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_lianHuan, true);
            }
            FightManagerForPvp.instance.CreateSateIcon(tieQiCards[tieQiCards.Count - 1].cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_lianHuan, true);
        }
        else
        {
            for (int i = 0; i < tieQiCards.Count; i++)
            {
                FightManagerForPvp.instance.DestroySateIcon(tieQiCards[i].cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_lianHuan, true);
            }
        }
    }
    ...
    private void ManZuSkill(FightCardData attackUnit, FightCardData attackedUnit)
    {
        ...
        if (attackedUnit.cardType == 0 && attackedUnit.nowHp > 0)
        {
            if (TakeSpecialAttack(LoadJsonFile.GetGameValue(51)))
            {
                ...
                {
                    FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_poisoned, true);
                }
    ...
    private void HuoChuanSkill(int finalDamage, FightCardData attackUnit, FightCardData attackedUnit)
    {
        ...
        if (attackUnit.nowHp / (float)attackUnit.fullHp <= LoadJsonFile.GetGameValue(54) / 100f)
        {
            ...
            FightCardData[] fightCardDatas = attackUnit.isPlayerCard ? FightManagerForPvp.instance.enemyFightCardsDatas : FightManagerForPvp.instance.playerFightCardsDatas;
            for (int i = 0; i < FightManagerForPvp.instance.CardNearbyAdditionForeach[targetIndex].Length; i++)
            {
                FightCardData attackedUnits = fightCardDatas[FightManagerForPvp.instance.CardNearbyAdditionForeach[targetIndex][i]];
    ...
    private void ClearOneUnitBadState(FightCardData cardData)
    {
        if (cardData.fightState.dizzyNums > 0)
        {
            ...
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_dizzy, true);
        }
        if (cardData.fightState.imprisonedNums > 0)
        {
            cardData.fightState.imprisonedNums = 0;
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_imprisoned, true);
        }
        if (cardData.fightState.bleedNums > 0)
        {
            cardData.fightState.bleedNums = 0;
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_bleed, true);
        }
        if (cardData.fightState.poisonedNums > 0)
        {
            cardData.fightState.poisonedNums = 0;
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_poisoned, true);
        }
        if (cardData.fightState.burnedNums > 0)
        {
            cardData.fightState.burnedNums = 0;
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_burned, true);
        }
        if (cardData.fightState.removeArmorNums > 0)
        {
            cardData.fightState.removeArmorNums = 0;
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_removeArmor, true);
        }
        if (cardData.fightState.cowardlyNums > 0)
        {
            cardData.fightState.cowardlyNums = 0;
            FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_cowardly, true);
        }
    }
            ...
            if (index != -1)
            {
                ...
                if (TakeSpecialAttack(prop))
                {
                    ...
                    if (classType == 45)  //美人
                    {
                        ...
                        {
                            FightManagerForPvp.instance.CreateSateIcon(fightCardDatas[index].cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_neizhu, false);
                        }
                    ...
                    {//大美人
                        ...
                        {
                            FightManagerForPvp.instance.CreateSateIcon(fightCardDatas[index].cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shenzhu, false);
                        }
    ...
    private void CiKePoJiaAttack(FightCardData attackedUnit, FightCardData attackUnit)
    {
        ...
        if (attackedUnit.cardType == 0)
        {
            ...
            if (TakeSpecialAttack(LoadJsonFile.GetGameValue(147)))
            {
                ...
                {
                    FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_bleed, true);
                }
            }
    ...
    IEnumerator TakeCardPosBack(FightCardData[] fightCardDatas, FightCardData attackedUnit, int nextPos, float waitTime, bool isPlayer)
    {
        ...
        FightManagerForPvp.instance.CardGoIntoBattleProcess(attackedUnit, attackedUnit.posIndex, fightCardDatas, false);

        ShowSpellTextObj(attackedUnit.cardObj, LoadJsonFile.GetStringText(17), true, true);
        attackedUnit.cardObj.transform.DOMove(
            isPlayer ? FightManagerForPvp.instance.enemyCardsPos[nextPos].transform.position : FightManagerForPvp.instance.playerCardsPos[nextPos].transform.position,
            waitTime
            ).SetEase(Ease.Unset).OnComplete(delegate ()
            {
                FightManagerForPvp.instance.CardGoIntoBattleProcess(attackedUnit, nextPos, fightCardDatas, true);
            });
    ...
    private int FuBingTuLuAttack(int finalDamage, FightCardData attackedUnit, FightCardData attackUnit)
    {
        ...
        if (attackedUnit.fightState.withStandNums > 0)
        {
            ...
            FightManagerForPvp.instance.DestroySateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_withStand, true);
        }
    ...
    private int ShenWuZhanYiAttack(int finalDamage, FightCardData attackUnit, FightCardData attackedUnit)
    {
        ...
        {
            FightManagerForPvp.instance.CreateSateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_willFight, true);
        }
    ...
    private void SiZhanStateCreate(FightCardData attackedUnit)
    {
        if (attackedUnit.fightState.deathFightNums == 0 && attackedUnit.nowHp > 0 && attackedUnit.nowHp / (float)attackedUnit.fullHp < (LoadJsonFile.GetGameValue(103) / 100f))
        {
            ...
            {
                FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_deathFight, true);
            }
                ...
                case "5":
                    if (fightCardData.nowHp / (float)fightCardData.fullHp <= (LoadJsonFile.GetGameValue(104) / 100f))
                    {
                        if (fightCardData.fightState.invincibleNums <= 0)
                        {
                            ...
                            FightManagerForPvp.instance.CreateSateIcon(fightCardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_invincible, true);
                        }
                    }
                    break;
                //敢死兵种添加死战
            ...
            if (attackedUnit.cardType == 0)
            {
                switch (LoadJsonFile.heroTableDatas[attackedUnit.cardId][5])
                {
                    case "1":
                        ...
                        if (attackedUnit.fightState.dizzyNums <= 0 && attackedUnit.fightState.imprisonedNums <= 0)
                        {
                            if (indexAttackType != 0)
                            {
                                if (attackedUnit.fightState.withStandNums <= 0)
                                {
                                    FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_withStand, true);
                                }
                    ...
                    case "12":
                        ...
                        {
                            FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_willFight, true);
                        }
    ...
    private bool OffsetWithStand(FightCardData fightCardData)
    {
        if (fightCardData.fightState.withStandNums > 0)
        {
            ...
            if (fightCardData.fightState.withStandNums <= 0)
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(fightCardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_withStand, true);
            }
            return true;
        }
        else
    ...
    private bool OffsetDizzyState(FightCardData dizzyUnit)
    {
        if (dizzyUnit.fightState.dizzyNums > 0)
        {
            ...
            if (dizzyUnit.fightState.dizzyNums <= 0)
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(dizzyUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_dizzy, true);
            }
            return true;
        }
        else
    ...
    private bool OffsetNeiZhuState(FightCardData attackUnit)
    {
        if (attackUnit.fightState.neizhuNums > 0)
        {
            ...
            if (attackUnit.fightState.neizhuNums <= 0)
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_neizhu, false);
            }
            return true;
        }
        else
    ...
    private bool OffsetShenZhuState(FightCardData attackUnit)
    {
        if (attackUnit.fightState.shenzhuNums > 0)
        {
            ...
            if (attackUnit.fightState.shenzhuNums <= 0)
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shenzhu, false);
            }
            return true;
        }
        else
    ...
    private void TakeOneUnitDizzed(FightCardData attackedUnit, int prob)
    {
        if (attackedUnit.cardType == 0 && TakeSpecialAttack(prob))
        {
            if (attackedUnit.fightState.dizzyNums <= 0)
            {
                FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_dizzy, true);
            }
    ...
    private void TakeToImprisoned(FightCardData attackedUnit, int prob)
    {
        if (attackedUnit.cardType == 0 && TakeSpecialAttack(prob))
        {
            ...
            {
                FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_imprisoned, true);
            }
    ...
    private void TakeToRemoveArmor(FightCardData attackedUnit, int prob)
    {
        if (attackedUnit.cardType == 0 && TakeSpecialAttack(prob))
        {
            ...
            {
                FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_removeArmor, true);
            }
    ...
    private void TakeToBurn(FightCardData attackedUnit, int prob)
    {
        if (attackedUnit.cardType == 0 && TakeSpecialAttack(prob))
        {
            ...
            {
                FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_burned, true);
            }
    ...
    private void TakeToCowardly(FightCardData attackedUnit, int prob)
    {
        if (attackedUnit.cardType == 0 && TakeSpecialAttack(prob))
        {
            ...
            {
                FightManagerForPvp.instance.CreateSateIcon(attackedUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_cowardly, true);
            }
    ...
    private int AddOrCutShieldValue(int damage, FightCardData attackUnit, bool isAdd)
    {
        ...
        if (attackUnit.cardType == 0)
        {
            if (isAdd)
            {
                ...
                {
                    FightManagerForPvp.instance.CreateSateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shield, true);
                }
                ...
                if (damage > 0)
                {
                    ...
                    else
                    {
                        if (attackUnit.fightState.shieldValue > 0)
                        {
                            ...
                            FightManagerForPvp.instance.DestroySateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shield, true);
                        }
                    }
                }
            }
    ...
    private void CollectiveRecoveryHp()
    {
        ...
        if (tongShuaiBurnRoundPy != -1)
        {
            ...
            {
                Transform obj = FightManagerForPvp.instance.enemyCardsPos[GoalGfSetFireRound[tongShuaiBurnRoundPy][i]].transform.Find(StringNameStatic.StateIconPath_burned);
                if (obj != null)
                    Destroy(obj.gameObject);
            }
        ...
        if (tongShuaiBurnRoundEm != -1)
        {
            ...
            {
                Transform obj = FightManagerForPvp.instance.playerCardsPos[GoalGfSetFireRound[tongShuaiBurnRoundEm][i]].transform.Find(StringNameStatic.StateIconPath_burned);
                if (obj != null)
                    Destroy(obj.gameObject);
            }
        ...
        //我方
        for (int i = 0; i < FightManagerForPvp.instance.playerFightCardsDatas.Length; i++)
        {
            fightCardData = FightManagerForPvp.instance.playerFightCardsDatas[i];
    ...
    {
        //if (AudioController0.instance.ChangeAudioClip(FightManagerForPvp.instance.audioClipsFightEffect[clipIndex], FightManagerForPvp.instance.audioVolumeFightEffect[clipIndex]))
        //{
        ...
        //    audioSource.clip = FightManagerForPvp.instance.audioClipsFightEffect[clipIndex];
        //    audioSource.volume = FightManagerForPvp.instance.audioVolumeFightEffect[clipIndex];
            ...
            if (i != 17 && fightCardData != null && fightCardData.cardType == 0 && fightCardData.nowHp > 0)
            {
                switch (LoadJsonFile.heroTableDatas[fightCardData.cardId][5])
                {
                    case "4"://盾兵
                        if (fightCardData.fightState.withStandNums <= 0)
                        {
                            FightManagerForPvp.instance.CreateSateIcon(fightCardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_withStand, true);
                        }
    ...
    private void LockFightCardState()
    {
        for (int i = 0; i < FightManagerForPvp.instance.playerFightCardsDatas.Length; i++)
        {
            if (i != 17 && FightManagerForPvp.instance.playerFightCardsDatas[i] != null)
            {
                if (!FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.GetComponent<CardDragForPvp>().isFightCard)
                {
                    FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.GetComponent<CardDragForPvp>().isFightCard = true;
                    FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.transform.GetChild(8).gameObject.SetActive(false);
                }
            }
        }
    }
    ...
    IEnumerator LiteForStartRound()
    {
        ...
        //FightManagerForPvp.instance.UpdateCardDataBeforeRound();
        roundNums++;
        targetIndex = -1;
        fightUnitIndex = 0;
        isPlayerRound = true;
    ...
    {
        FightCardData fightCardData;
        FightCardData[] cardDatas = isPlayer ? FightManagerForPvp.instance.playerFightCardsDatas : FightManagerForPvp.instance.enemyFightCardsDatas;
                    ...
                    for (int j = 0; j < jiBanActivedClass.cardTypeLists[i].cardLists.Count; j++)
                    {
                        ...
                        if (fightCardData != null && fightCardData.nowHp > 0)
                        {
                            ...
                            if (TakeSpecialAttack(LoadJsonFile.GetGameValue(134)))
                            {
                                ...
                                {
                                    FightManagerForPvp.instance.CreateSateIcon(fightCardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shenzhu, false);
                                }
                    ...
                    for (int j = 0; j < jiBanActivedClass.cardTypeLists[i].cardLists.Count; j++)
                    {
                        ...
                        if (fightCardData != null && fightCardData.nowHp > 0)
                        {
                            ...
                            if (TakeSpecialAttack(LoadJsonFile.GetGameValue(135)))
                            {
                                ...
                                {
                                    FightManagerForPvp.instance.CreateSateIcon(fightCardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_neizhu, false);
                                }
    ...
    private float UpdateCardDataBeforeRound()
    {
        ...
        for (int i = 0; i < FightManagerForPvp.instance.playerFightCardsDatas.Length; i++)
        {
            if (FightManagerForPvp.instance.playerFightCardsDatas[i] != null && FightManagerForPvp.instance.playerFightCardsDatas[i].nowHp > 0)
            {
                FightManagerForPvp.instance.playerFightCardsDatas[i].isActed = false;
                if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardType == 0)
                {
                    nowRounds = UpdateOneCardBeforeRound(FightManagerForPvp.instance.playerFightCardsDatas[i]);
                    //是否有统帅
                    if (!isHadTongShuai && FightManagerForPvp.instance.playerFightCardsDatas[i].nowHp > 0 &&
                        (LoadJsonFile.heroTableDatas[FightManagerForPvp.instance.playerFightCardsDatas[i].cardId][5] == "32" ||
                        LoadJsonFile.heroTableDatas[FightManagerForPvp.instance.playerFightCardsDatas[i].cardId][5] == "33"))
                    {
                        isHadTongShuai = true;
                    }
                }
                ...
                {
                    if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardType == 2)
                    {
                        switch (FightManagerForPvp.instance.playerFightCardsDatas[i].cardId)
                        {
                            case 0:
                                //营寨回合开始回血
                                int addHp = (int)(LoadJsonFile.GetGameValue(120) / 100f * FightManagerForPvp.instance.playerFightCardsDatas[i].fullHp);
                                FightManagerForPvp.instance.playerFightCardsDatas[i].nowHp += addHp;
                                AttackedAnimShow(FightManagerForPvp.instance.playerFightCardsDatas[i], addHp, true);
                                break;
                            //case 17:
                            //    //迷雾阵迷雾动画开启
                            //    for (int j = 0; j < FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.transform.childCount; j++)
                            //    {
                            //        if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.transform.GetChild(j).name == StringNameStatic.StateIconPath_miWuZhenAddtion + "Din")
                            //        {
                            //            if (!FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.transform.GetChild(j).GetComponent<Animator>().enabled)
                            //            {
                            //                FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj.transform.GetChild(j).GetComponent<Animator>().enabled = true;
                            //            }
                            //            else
                            //            {
                            //                break;
                ...
                //滚石滚木列表添加
                if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardType == 3)
                {
                    if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardId == 9)
                    {
                        gunShiCards.Add(FightManagerForPvp.instance.playerFightCardsDatas[i]);
                    }
                    if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardId == 10)
                    {
                        gunMuCards.Add(FightManagerForPvp.instance.playerFightCardsDatas[i]);
                    }
                }
            }
        ...
        for (int i = 0; i < FightManagerForPvp.instance.enemyFightCardsDatas.Length; i++)
        {
            if (FightManagerForPvp.instance.enemyFightCardsDatas[i] != null && FightManagerForPvp.instance.enemyFightCardsDatas[i].nowHp > 0)
            {
                FightManagerForPvp.instance.enemyFightCardsDatas[i].isActed = false;
                if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardType == 0)
                {
                    nowRounds = UpdateOneCardBeforeRound(FightManagerForPvp.instance.enemyFightCardsDatas[i]);
                    //是否有统帅
                    if (!isHadTongShuai && FightManagerForPvp.instance.enemyFightCardsDatas[i].nowHp > 0 &&
                        (LoadJsonFile.heroTableDatas[FightManagerForPvp.instance.enemyFightCardsDatas[i].cardId][5] == "32" ||
                        LoadJsonFile.heroTableDatas[FightManagerForPvp.instance.enemyFightCardsDatas[i].cardId][5] == "33"))
                    {
                        isHadTongShuai = true;
                    }
                }
                ...
                {
                    if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardType == 2)
                    {
                        switch (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardId)
                        {
                            case 0:
                                //营寨回合开始回血
                                int addHp = (int)(LoadJsonFile.GetGameValue(120) / 100f * FightManagerForPvp.instance.enemyFightCardsDatas[i].fullHp);
                                FightManagerForPvp.instance.enemyFightCardsDatas[i].nowHp += addHp;
                                AttackedAnimShow(FightManagerForPvp.instance.enemyFightCardsDatas[i], addHp, true);
                                break;
                            case 17:
                                //迷雾阵迷雾动画开启
                                Transform tran = FightManagerForPvp.instance.enemyFightCardsDatas[i].cardObj.transform;
                            ...
                            case 18:
                                //迷雾阵迷雾动画开启
                                Transform tran0 = FightManagerForPvp.instance.enemyFightCardsDatas[i].cardObj.transform;
                ...
                //滚石滚木列表添加
                if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardType == 3)
                {
                    if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardId == 9)
                    {
                        gunShiCards.Add(FightManagerForPvp.instance.enemyFightCardsDatas[i]);
                    }
                    if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardId == 10)
                    {
                        gunMuCards.Add(FightManagerForPvp.instance.enemyFightCardsDatas[i]);
                    }
                }
            }
            if (maxRounds < nowRounds)
    ...
    private void UpdateCardStateAfterRound()
    {
        ...
        for (int i = 0; i < FightManagerForPvp.instance.playerFightCardsDatas.Length; i++)
        {
            if (i != 17 && FightManagerForPvp.instance.playerFightCardsDatas[i] != null)
            {
                if (FightManagerForPvp.instance.playerFightCardsDatas[i].nowHp > 0)
                {
                    OnCardStateUpdate(FightManagerForPvp.instance.playerFightCardsDatas[i]);
                }
                if (FightManagerForPvp.instance.playerFightCardsDatas[i].nowHp <= 0)
                {
                    if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardType == 0)
                    {
                        //羁绊消除
                        FightManagerForPvp.instance.TryToActivatedBond(FightManagerForPvp.instance.playerFightCardsDatas[i], false);

                        switch (LoadJsonFile.heroTableDatas[FightManagerForPvp.instance.playerFightCardsDatas[i].cardId][5])
                        {
                            case "58": //铁骑阵亡
                                UpdateTieQiStateIconShow(FightManagerForPvp.instance.playerFightCardsDatas[i], false);
                                break;
                            default:
                                break;
                        }
                    ...
                    {
                        if (FightManagerForPvp.instance.playerFightCardsDatas[i].cardType == 2) //塔倒了
                        {
                            FightManagerForPvp.instance.CardGoIntoBattleProcess(FightManagerForPvp.instance.playerFightCardsDatas[i], i, FightManagerForPvp.instance.playerFightCardsDatas, false);
                        }
                    }
                    Destroy(FightManagerForPvp.instance.playerFightCardsDatas[i].cardObj);
                    FightManagerForPvp.instance.playerFightCardsDatas[i] = null;
                }
            }
        }
        //敌方
        for (int i = 0; i < FightManagerForPvp.instance.enemyFightCardsDatas.Length; i++)
        {
            if (i != 17 && FightManagerForPvp.instance.enemyFightCardsDatas[i] != null)
            {
                if (FightManagerForPvp.instance.enemyFightCardsDatas[i].nowHp > 0)
                {
                    OnCardStateUpdate(FightManagerForPvp.instance.enemyFightCardsDatas[i]);
                }
                if (FightManagerForPvp.instance.enemyFightCardsDatas[i].nowHp <= 0)
                {
                    if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardType == 0)
                    {
                        //羁绊消除
                        FightManagerForPvp.instance.TryToActivatedBond(FightManagerForPvp.instance.enemyFightCardsDatas[i], false);

                        switch (LoadJsonFile.heroTableDatas[FightManagerForPvp.instance.enemyFightCardsDatas[i].cardId][5])
                        {
                            case "58": //铁骑阵亡
                                UpdateTieQiStateIconShow(FightManagerForPvp.instance.enemyFightCardsDatas[i], false);
                                break;

                            default:
                                break;
                        }
                        OnClearCardStateUpdate(FightManagerForPvp.instance.enemyFightCardsDatas[i]);
                    }
                    else
                    {
                        if (FightManagerForPvp.instance.enemyFightCardsDatas[i].cardType == 2) //塔倒了
                        {
                            FightManagerForPvp.instance.CardGoIntoBattleProcess(FightManagerForPvp.instance.enemyFightCardsDatas[i], i, FightManagerForPvp.instance.enemyFightCardsDatas, false);
                        }
                    }
                    Destroy(FightManagerForPvp.instance.enemyFightCardsDatas[i].cardObj);
                    FightManagerForPvp.instance.enemyFightCardsDatas[i] = null;
                }
            }
        }
    }
    ...
    private void OnClearCardStateUpdate(FightCardData cardData)
    {
        try
        {
            ...
            if (cardData.fightState.withStandNums > 0)      //护盾状态
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_withStand, true);
            }
            if (cardData.fightState.invincibleNums > 0)     //无敌消减
            {
                cardData.fightState.invincibleNums = 0;
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_invincible, true);
            }
            if (cardData.fightState.deathFightNums > 0)     //死战状态
            {
                cardData.fightState.deathFightNums = 0;
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_deathFight, true);
            }
            if (cardData.fightState.willFightNums > 0)      //战意状态
            {
                cardData.fightState.willFightNums = 0;
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_willFight, true);
            }
            if (cardData.fightState.neizhuNums > 0)         //内助状态
            {
                cardData.fightState.neizhuNums = 0;
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_neizhu, false);
            }
            if (cardData.fightState.shenzhuNums > 0)        //神助状态
            {
                cardData.fightState.shenzhuNums = 0;
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shenzhu, false);
            }
            ...
            if (cardData.fightState.miWuZhenAddtion > 0)    //隐蔽状态
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_miWuZhenAddtion, false);
            }
            if (cardData.fightState.shieldValue > 0)        //防护盾状态
            {
                cardData.fightState.shieldValue = 0;
                FightManagerForPvp.instance.DestroySateIcon(cardData.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_shield, true);
            }
        }
    ...
    IEnumerator InitiativeHeroAction(FightCardData attackUnit, FightCardData[] cardsDatas)
    {
        ...
        /////////攻击//////////
        FightCardData attackedUnit = isPlayerRound ? FightManagerForPvp.instance.enemyFightCardsDatas[targetIndex] : FightManagerForPvp.instance.playerFightCardsDatas[targetIndex];
    ...
    private void CardMoveToFight()
    {
        ...
        if (isPlayerRound)
        {
            attackUnit = FightManagerForPvp.instance.playerFightCardsDatas[fightUnitIndex];
            cardDatas = FightManagerForPvp.instance.playerFightCardsDatas;
        }
        else
        {
            attackUnit = FightManagerForPvp.instance.enemyFightCardsDatas[fightUnitIndex];
            cardDatas = FightManagerForPvp.instance.enemyFightCardsDatas;
        }
        //主动单位并且可行动
    ...
    private int FindOpponentIndex(FightCardData attackUnit)
    {
        ...
        if (attackUnit.isPlayerCard)
        {
            ...
            {
                if (FightManagerForPvp.instance.enemyFightCardsDatas[AttackSelectionOrder[arrIndex][index]] != null
                    && FightManagerForPvp.instance.enemyFightCardsDatas[AttackSelectionOrder[arrIndex][index]].nowHp > 0)
                {
                    break;
                }
            }
        ...
        else
        {
            for (; index < AttackSelectionOrder[arrIndex].Length; index++)
            {
                if (FightManagerForPvp.instance.playerFightCardsDatas[AttackSelectionOrder[arrIndex][index]] != null
                    && FightManagerForPvp.instance.playerFightCardsDatas[AttackSelectionOrder[arrIndex][index]].nowHp > 0)
                {
                    break;
                }
            }
    ...
    private float ConfirmAttackStatus(FightCardData attackUnit)
    {
        ...
        if (attackUnit.fightState.shenzhuNums <= 0 && attackUnit.fightState.neizhuNums <= 0 && attackUnit.fightState.cowardlyNums > 0) //怯战无法使用暴击和会心一击
        {
            ...
            if (attackUnit.fightState.cowardlyNums <= 0)
            {
                ...
                FightManagerForPvp.instance.DestroySateIcon(attackUnit.cardObj.transform.GetChild(7), StringNameStatic.StateIconPath_cowardly, true);
            }
        }
        else
        {
    ...
    IEnumerator InitiativeTowerAction(FightCardData attackUnit, FightCardData[] cardsDatas)
    {
        ...
        FightManagerForPvp.instance.ActiveTowerFight(attackUnit, cardsDatas);
    ...
    {
        boomUIObj.transform.position = FightManagerForPvp.instance.enemyCardsPos[17].transform.position;
        fireUIObj.transform.position = gongKeUIObj.transform.position = FightManagerForPvp.instance.enemyCardsPos[7].transform.position;
        ...
        if (fightUnitIndex != -1)
        {
            ...
            if (isPlayerRound)
            {
                CardMoveToTargetPos(
                    attackUnit.cardObj,
                    new Vector3(
                        FightManagerForPvp.instance.enemyCardsPos[targetIndex].transform.position.x,
                        FightManagerForPvp.instance.enemyCardsPos[targetIndex].transform.position.y - FightManagerForPvp.instance.floDisY,
                        FightManagerForPvp.instance.enemyCardsPos[targetIndex].transform.position.z),
                    false,
                    true
                    );
            }
            else
            {
                CardMoveToTargetPos(
                    attackUnit.cardObj,
                    new Vector3(
                        FightManagerForPvp.instance.playerCardsPos[targetIndex].transform.position.x,
                        FightManagerForPvp.instance.playerCardsPos[targetIndex].transform.position.y + FightManagerForPvp.instance.floDisY,
                        FightManagerForPvp.instance.playerCardsPos[targetIndex].transform.position.z),
                    false,
                    false
                    );
            }
    ...
    private void CardBackToSelfPosFun()
    {
        if (isPlayerRound)
        {
            CardMoveToTargetPos(FightManagerForPvp.instance.playerFightCardsDatas[fightUnitIndex].cardObj, FightManagerForPvp.instance.playerCardsPos[fightUnitIndex].transform.position, true, true);
        }
        else
        {
            CardMoveToTargetPos(FightManagerForPvp.instance.enemyFightCardsDatas[fightUnitIndex].cardObj, FightManagerForPvp.instance.enemyCardsPos[fightUnitIndex].transform.position, true, false);
        }
    }
    ...
    private void CardMoveToTargetPos(GameObject cardObj, Vector3 targetPos, bool isBack, bool isPlayerCard)
    {
        if (isBack)
        {
            ...
            {
                ChangeGameObjParent(cardObj, isPlayerCard ? FightManagerForPvp.instance.playerCardsBox : FightManagerForPvp.instance.enemyCardsBox);
            });
        }
        else
        {
            ...
            Vector3 vec = new Vector3(
                targetPos.x,
                targetPos.y + (isPlayerRound ? (-1 * posFloat) : posFloat) * FightManagerForPvp.instance.oneDisY,
                targetPos.z
                );
